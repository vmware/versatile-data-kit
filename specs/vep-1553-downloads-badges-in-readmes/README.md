...
# VEP-1553: Download badges in readmes

* **Author(s):** Christian Foyer (chrfoyer@gmail.com) <!-- main contributors to the proposal (not just writers) and expected points of contact for questions -->
* **Status:** draft
...
-->
When looking at the source code in GitHub, it is helpful to have an idea of how often something is used. This is particularly the case for a monolithic repository like VDK, which contains many plugins.
