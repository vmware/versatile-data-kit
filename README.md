...
A preview of the VDK CLI commands - `vdk create`, `vdk run` and `vdk deploy`:
     <img src="https://github.com/vmware/versatile-data-kit/blob/person/zverulacis/gif/support/images/versatile-data-kit-cli.gif.gif" />
