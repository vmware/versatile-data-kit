...
def test_create_table():
    db = "my_db"
    table_name = "my_table"
    columns = {"int_column": int, "string_column": str, "bool_column": bool, "date_column": datetime,
               "float_column": float}
...
def test_insert_table_row():
    db = "my_db"
    table_name = "my_table"
    row = {"int_col": 1, "str_col": "str", "float_col": 3.14, "bool_col": True,
    ...
    expected = "INSERT INTO my_db.my_table (int_col,str_col,float_col,bool_col,date_col) values " \
...
def test_select_data():
    db = "my_db"
    table_name = "my_table"
    column_filters = {"int_column": 1, "string_column": "str", "bool_column": False,
    ...
    assert len(queries) > 0
    expected = "select * from my_db.my_table where " \
