...
class Installer:
    ...
    def __helm_install_command(self, git_server_ip):
        return [
            ...
            "--set",
            "database.jdbcUrl=jdbc:postgresql://vdk-postgresql:5432/pgdb?sslmode=disable",
            "--set",
            ...
            "--set",
            "postgresql.auth.username=pguser",
            "--set",
            "postgresql.auth.password=pgpass",
            "--set",
            "postgresql.auth.postgresPassword=pgpass",
            "--set",
            "postgresql.auth.database=pgdb",
            "--set",
            "replicas=1",
            "--set",
