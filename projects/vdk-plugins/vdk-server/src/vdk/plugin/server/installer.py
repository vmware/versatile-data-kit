...
class Installer:
    ...
    def __helm_install_command(self, git_server_ip):
        chart_directory = "/Users/ysalambashev/IdeaProjects/versatile-data-kit/projects/control-service/projects/helm_charts/pipelines-control-service"
        return [
            "helm",
            "install",
            "--debug",
            ...
            "--set",
            "image.registry=ghcr.io/versatile-data-kit-dev/dp/versatiledatakit",
            "--set",
            "image.tag=latest",
            "--set",
            "operationsUi.image.registry=ghcr.io/versatile-data-kit-dev/dp/versatiledatakit",
            "--set",
            "operationsUi.image.tag=latest",
            "--set",
            ...
            # "--set",
            # "database.jdbcUrl=jdbc:postgresql://vdk-postgresql:5432/testdb3?sslmode=disable",
            # "--set",
            ...
            # "--set",
            # "postgresql.image.tag=15.6.0-debian-12-r14",
            # "--set",
            # "postgresql.auth.username=testuser",
            # "--set",
            # "postgresql.auth.password=testpass",
            # "--set",
            # "postgresql.auth.postgresPassword=testpass",
            # "--set",
            # "postgresql.auth.database=testdb3",
            # "--set",
            # "postgresql.primary.service.public.type=ClusterIP",
            # "--set",
