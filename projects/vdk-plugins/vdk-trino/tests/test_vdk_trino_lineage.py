...
def execute_query(runner, query: str) -> None:
...
class TestVdkTrinoLineage(unittest.TestCase):
    def test_lineage_not_collected_for_heartbeat_query(self):
    ...
    def test_lineage_for_insert(self):
    ...
    def test_lineage_for_select(self):
    ...
    def test_lineage_for_insert_select(self):
    ...
    def test_lineage_for_insert_select_full_names(self):
        ...
        execute_query(
            runner,
            f"create table {test_schema}.{table_name_source} (test_column varchar)",
        )
        execute_query(
            runner,
            f"create table {test_schema}.{table_name_dest} (test_column varchar)",
        )
    ...
    def test_lineage_for_rename_table(self):
    ...
    def test_lineage_for_rename_table_full_names(self):
        test_schema = "memory.test_schema"
        table_name_from = "test_table_" + uuid.uuid4().hex
        table_name_to = "test_table_" + uuid.uuid4().hex
        ...
        execute_query(
            runner,
            f"create table {test_schema}.{table_name_from} (test_column varchar)",
        )
    ...
    def test_lineage_for_rename_table_if_exists(self):
        table_name_from = "test_table_" + uuid.uuid4().hex
        table_name_to = "test_table_" + uuid.uuid4().hex
    ...
    def test_lineage_not_collected_for_some_queries(self):
        table_name = "test_table_" + uuid.uuid4().hex
