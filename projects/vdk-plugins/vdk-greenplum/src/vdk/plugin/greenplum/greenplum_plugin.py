...
def vdk_configure(config_builder: ConfigurationBuilder) -> None:
    ...
    config_builder.add(key="GREENPLUM_DBNAME", description="Database name")
    config_builder.add(key="GREENPLUM_USER", description="User name")
    config_builder.add(key="GREENPLUM_PASSWORD", description="User password")
    config_builder.add(
        key="GREENPLUM_HOST",
