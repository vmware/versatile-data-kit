...
This template can be used to load raw data from Data Lake to target Table in Data Warehouse.
In summary, it appends all records from the source table to the target table.
...
Say there is SDDC-related Table called 'fact_vmc_utilization_cpu_mem_every5min_daily' in 'history' schema.
