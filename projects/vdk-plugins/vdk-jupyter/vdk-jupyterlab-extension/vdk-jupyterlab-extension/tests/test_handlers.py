...
async def test_run_job_post(jp_fetch):
    ...
    response = await jp_fetch("vdk-jupyterlab-extension", "run", method="POST", body=json.dumps(body))
...
async def test_delete_job_post(jp_fetch):
    ...
    response = await jp_fetch("vdk-jupyterlab-extension", "delete", method="POST", body=json.dumps(body))
...
async def test_download_job_post(jp_fetch):
    ...
    response = await jp_fetch("vdk-jupyterlab-extension", "download", method="POST", body=json.dumps(body))
...
async def test_create_job_post(jp_fetch):
    ...
    response = await jp_fetch("vdk-jupyterlab-extension", "create", method="POST", body=json.dumps(body))
