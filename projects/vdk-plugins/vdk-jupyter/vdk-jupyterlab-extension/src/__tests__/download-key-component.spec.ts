 ...
 */
import DownloadKeyDialog from '../components/DownloadKey';
...
describe('#render()', () => {
  it('should return contain job name input with placeholder equal to jobName from props', () => {
    const component = render(new DownloadKeyDialog(defaultProps).render());
  ...
  it('should return contain key path input with placeholder equal to jobPath from props', () => {
    const component = render(new DownloadKeyDialog(defaultProps).render());
...
describe('#onPathChange', () => {
  it('should change the key path in jobData', () => {
    const component = render(new DownloadKeyDialog(defaultProps).render());
    const input = component.getByPlaceholderText(defaultProps.jobPath);
