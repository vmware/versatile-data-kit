...
export const CHECK_STATUS_BUTTON_LABEL = 'Check Status';
export const CHECK_STATUS_BUTTON_CLASS = 'jp-vdk-check-status-button';
export const CHECK_STATUS_BUTTON_COMMAND_ID = 'jp-vdk:check-status-button';
export const CHECK_STATUS_BUTTON_ID = 'jp-vdk-check-status-button';
