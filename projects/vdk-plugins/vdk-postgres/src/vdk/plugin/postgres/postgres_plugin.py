...
def vdk_configure(config_builder: ConfigurationBuilder) -> None:
    ...
    config_builder.add(key="POSTGRES_DBNAME", description="Database name")
    config_builder.add(key="POSTGRES_USER", description="User name")
    config_builder.add(key="POSTGRES_PASSWORD", description="User password")
    config_builder.add(
        key="POSTGRES_HOST",
