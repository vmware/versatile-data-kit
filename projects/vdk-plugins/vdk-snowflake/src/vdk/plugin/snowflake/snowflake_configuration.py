...
def add_definitions(config_builder: ConfigurationBuilder):
    ...
    config_builder.add(key=SNOWFLAKE_USER, description="User name")
    config_builder.add(key=SNOWFLAKE_PASSWORD, description="User password")
    config_builder.add(
    ...
    config_builder.add(key=SNOWFLAKE_SCHEMA, description="The database schema")
