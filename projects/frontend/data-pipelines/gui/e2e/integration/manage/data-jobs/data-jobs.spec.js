    ...
    () => {
        ...
        before(() => {
            return DataJobsManagePage.recordHarIfSupported()
                ...
                .then(() =>
                    DataJobsManagePage.createShortLivedTestJobWithDeploy('v0')
                )
                .then(() =>
                    DataJobsManagePage.loadShortLivedTestJobFixtureWithDeploy(
                        'v0'
                    ).then((loadedTestJob) => {
                ...
                .then(() =>
                    DataJobsManagePage.createShortLivedTestJobsNoDeploy()
                )
                .then(() =>
