...
export class DataJobsApiService {
    ...
    getJobs(
        ...
        pageNumber: number,
        pageSize: number): Observable<ApolloQueryResult<DataJobPage>> {
    ...
    getJob(teamName: string, jobName: string): Observable<DataJob> {
        return this.dataJobsBaseService.getJobs(
            ...
            map((response: ApolloQueryResult<DataJobPage>) => {
                if (!CollectionsUtil.isArray(response?.data?.content)
    ...
    getJobExecutions(
        teamName: string,
        jobName: string): Observable<DataJobExecutionDetails[]>;
    getJobExecutions(
        teamName: string,
        jobName: string,
        ...
        pageNumber?: number,
        pageSize?: number): Observable<DataJobExecutionsPage>;
    getJobExecutions(
        teamName: string,
        jobName: string,
        forceGraphQL = false,
        ...
        pageSize: number = null): Observable<DataJobExecutionDetails[]> | Observable<DataJobExecutionsPage> {
        ...
        return this.dataJobsBaseService.getExecutions(
            teamName,
    ...
    updateDataJobStatus(
        ...
        jobName: string,
        deploymentId: string,
        dataJobEnabled: boolean): Observable<{ enabled: boolean }> {
