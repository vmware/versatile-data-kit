 ...
 *
 *   - e.g. TMS Control Plane or SuperCollider Control Plane, etc..
 *
 * @author gorankokin
 */
@Injectable()
...
export class NavigationService {
     ...
     */
    navigateTo(replaceValues?: { [key: string]: ArrayElement<TaurusNavigateAction['replacers']>['replaceValue'] },
     ...
     * @param activatedRoute is optional and could be provided if you want those state to be used to extract RouteConfig and NavigationAction.
     */
    navigateBack(replaceValues?: { [key: string]: ArrayElement<TaurusNavigateAction['replacers']>['replaceValue'] },
                 activatedRoute?: ActivatedRoute | ActivatedRouteSnapshot): Promise<boolean> {
     ...
     * @param activatedRoute is optional and could be provided if you want those state to be used to extract RouteConfig and NavigationAction.
     */
    redirect(replaceValues?: { [key: string]: ArrayElement<TaurusNavigateAction['replacers']>['replaceValue'] },
             activatedRoute?: ActivatedRoute | ActivatedRouteSnapshot): Promise<boolean> {
    ...
    private _navigateWithAction(
        ...
        dataKey: 'navigateTo' | 'navigateBack' | 'redirect'): Promise<boolean> {
    ...
    private _constructNavigateParameters(state: RouteState, dataKey: 'navigateTo' | 'navigateBack' | 'redirect'): Promise<NavigationParameters> {
