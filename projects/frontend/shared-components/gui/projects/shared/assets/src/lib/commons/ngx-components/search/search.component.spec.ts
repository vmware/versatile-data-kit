...
let comp: VmwSearchComponent;
let fixture: ComponentFixture<VmwSearchComponent>;
let page: PageObject;
...
describe('VmwSearchComponent', () => {
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(VmwSearchComponent);
