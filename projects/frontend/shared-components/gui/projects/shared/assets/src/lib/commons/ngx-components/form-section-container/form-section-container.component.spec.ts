import { VmwFormSectionContainerComponent } from './form-section-container.component';
...
import { FORM_STATE, VMWFormState } from './form-section-container.component';
import { VmwFormSectionComponent } from '../form-section';
import { VmwSimpleTranslateModule, VmwSimpleTranslateService } from "../../ngx-utils";
...
class PageObject {
    ...
    populateLocators(): void {
        this.fixtureElement = fixture.debugElement.query(By.css("vmw-form-section-container"));
    }
...
@Component({
    template: `
    <form [formGroup]="editProfileForm" (ngSubmit)="doSubmit(editProfileForm.value)">

        <vmw-form-section-container
...
class TestHostComponent {
    @ViewChild(VmwFormSectionContainerComponent, { static: false }) child: VmwFormSectionContainerComponent;
...
describe("Form Section Container Component", () => {
    ...
    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [
                ...
                VmwFormSectionContainerComponent,
            ]
        });
    ...
    it("should show Readonly and Edit section after save", () => {
        ...
        hostComp.formState = new VMWFormState(FORM_STATE.CAN_EDIT);
        fixture.detectChanges();
