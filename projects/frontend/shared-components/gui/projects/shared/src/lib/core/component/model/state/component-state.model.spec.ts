...
describe('ComponentStateImpl', () => {
    ...
    beforeEach(() => {
        ...
        const errorRecords: ErrorRecord[] = [
            {
                code: generateErrorCode('RandomClassName', 'RandomPublicName', 'randomMethod', 'unknown'),
    ...
    it('should verify will correctly assign default values', () => {
        // When
        const instances: ComponentState[] = [new ComponentStateImpl({}), new ComponentStateImpl(undefined)];
