        ...
        describe('Methods::()', () => {
            ...
            describe('|dateISO|', () => {
                it('should verify will return Date in ISO format', () => {
                    ...
                    expect(/^(-?(?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[01]|0[1-9]|[12][0-9])T(2[0-3]|[01][0-9]):([0-5][0-9]):([0-5][0-9])(\.[0-9]+)?(Z|[+-](?:2[0-3]|[01][0-9]):[0-5][0-9])?$/.test(res));
                });
            });
            ...
            describe('|iterateObject|', () => {
                ...
                it('should verify will return null immediately if value is null', () => {
                    // When/Then
                    let cnt = 0;
                    const r = CollectionsUtil.iterateObject(null, () => {
                        cnt++;
                    }, 'objectLookLike');
            ...
            describe('|areMapsEqual|', () => {
                ...
                it('should verify will return false when maps are different reference, same size and different content', () => {
                    ...
                    const map4 = new Map<string, any>([['val0', 1], ['val2', 2], ['val3', 3], ['val-undefined', undefined]]);
                    const map5 = new Map<string, any>([['val0', 1], ['val2', 2], ['val3', 3], ['val4', 4]]);
