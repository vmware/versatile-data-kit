...
describe('Route Classes', () => {
    describe('RouteSegments', () => {
        it('should verify instance is created', () => {
            // When
            const instance = new RouteSegments('domain/context', {}, {}, {}, null, null);
            ...
            describe('Methods::', () => {
                describe('|of|', () => {
                    it('should verify factory method will create instance', () => {
                        // When
                        const instance = RouteSegments.of('domain/context', {}, {}, null, null);
                ...
                it('should verify will return param', () => {
                    ...
                    const routeSegments = RouteSegments.of(
                        ...
                        RouteSegments.of(
                            ...
                            { entityId: '17' },
                            null,
                            RouteSegments.of('domain/context', null, null, null, null, 'domain/context'),
            ...
            describe('|getParam|', () => {
                it('should verify will return param', () => {
                    ...
                    const routeSegments = RouteSegments.of(
                        ...
                        { billId: '105' },
                        {},
                        RouteSegments.of('entity/17', {}, { entityId: '17' }, {}, null, 'entity/:entityId'),
                        'bill/:billId'
                    );
        ...
        beforeEach(() => {
            routeSegments = RouteSegments.of(
                ...
                RouteSegments.of(
                    ...
                    null,
                    null,
                    RouteSegments.of('domain/context', {}, null, null, null, 'domain/context'),
                    'entity/:entityId/explore'
                ),
                'bill/:billId/view'
            );

            routeState = RouteState.of(routeSegments, 'domain/context/entity/17/explore/bill/105/view');
        });

        it('should verify instance is created', () => {
            // When
            const instance = new RouteState(new RouteSegments('domain/context', {}, {}, null, null), 'domain/context');
        ...
        describe('Statics::', () => {
            describe('Methods::', () => {
                describe('|of|', () => {
                    it('should verify factory method will create instance', () => {
                        // When
                        const instance = RouteState.of(new RouteSegments('domain/context', {}, {}, null, null), 'domain/context');
    ...
    describe('RouterState', () => {
        ...
        it('should verify instance is created', () => {
            // When
            const instance = new RouterState(new RouteState(new RouteSegments('domain/context', {}, {}, null, null), 'domain/context'), 8);
                ...
                describe('|of|', () => {
                    it('should verify factory method will create instance', () => {
                        ...
                        const instance = RouterState.of(
                            new RouteState(new RouteSegments('domain/context', {}, {}, null, null), 'domain/context'),
                            11
                        );
        ...
        describe('Methods::', () => {
            describe('|getPrevious|', () => {
                beforeEach(() => {
                    routerState.previousStates.push(...previousRouterState.previousStates);
            ...
            describe('|appendPrevious|', () => {
                ...
                it('should verify will pop the oldest one and will unshift the new one when buffer has 10 elements', () => {
                    ...
                    expect(previousRouterState.previousStates[0]).toEqual(RouterState.of(RouteState.empty(), 13));
                    expect(previousRouterState.previousStates[9]).toEqual(RouterState.of(RouteState.empty(), 4));
                    ...
                    expect(routerState.previousStates[0]).toEqual(RouterState.of(RouteState.empty(), 14));
                    expect(routerState.previousStates[9]).toEqual(RouterState.of(RouteState.empty(), 5));
                });
                ...
                it(`should verify won't add new state when previousState has same navigationId like current`, () => {
                    ...
                    expect(previousRouterState.previousStates[0]).toEqual(RouterState.of(RouteState.empty(), 13));
                    expect(previousRouterState.previousStates[2]).toEqual(RouterState.of(RouteState.empty(), 11));
                    ...
                    expect(routerState.previousStates[0]).toEqual(RouterState.of(RouteState.empty(), 13));
                    expect(routerState.previousStates[2]).toEqual(RouterState.of(RouteState.empty(), 11));
                });
            });
        });
    });
