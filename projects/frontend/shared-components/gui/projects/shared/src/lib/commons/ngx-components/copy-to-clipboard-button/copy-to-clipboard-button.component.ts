...
import { VmwSimpleTranslateService } from '../../ngx-utils';
...
@Component({
    selector: 'vmw-copy-to-clipboard-button',
...
export class VmwCopyToClipboardButtonComponent implements OnInit {
    ...
    constructor(private el: ElementRef, public translateService: VmwSimpleTranslateService) {
