...
describe('ComponentsStateHelper', () => {
    ...
    describe('Methods::', () => {
        ...
        beforeEach(() => {
            ...
            literalComponentsState = createComponentsLiteralState(componentState1, componentState2, componentState3, componentState4);
        ...
        describe('|getLiteralComponentState|', () => {
            it('should verify will return LiteralComponentState', () => {
                ...
                expect(state).toEqual(
                    literalComponentsState.routePathSegments['test_domain/context'].routePathSegments['test_entity/10'].components[
                        'component3'
                    ]
                );
            });
        ...
        describe('|updateLiteralComponentState|', () => {
            it('should verify will update state in right routePathSegments', () => {
                ...
                // Then 1
                expect(
                    helper.getState().routePathSegments['test_domain/context'].routePathSegments['test_entity/10'].components['component1']
