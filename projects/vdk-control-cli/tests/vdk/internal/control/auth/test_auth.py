...
from vdk.internal.control.auth.auth import AuthenticationCache
from vdk.internal.control.auth.auth import AuthenticationCacheSerDe
...
def test_auth_updates():
    with patch(
        "vdk.internal.control.configuration.vdk_config.VDKConfigFolder"
    ) as mock_conf:
