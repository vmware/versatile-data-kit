...
JDBC: {{ default (printf "jdbc:postgresql://%s-postgresql:5432/%s?sslmode=disable" .Release.Name (default "postgres" .Values.postgresql.auth.database)) .Values.database.jdbcUrl | b64enc |quote }}
{{- else -}}
