...
public class V1CronJobDeployer implements CronJobDeployer {
    ...
    public V1CronJobDeployer(@org.springframework.beans.factory.annotation.Value(
            "${datajobs.control.k8s.data.job.template.file}") String datajobTemplateFileLocation, @Qualifier("deploymentBatchV1Api") BatchV1Api batchV1Api,
