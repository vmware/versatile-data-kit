...
public class V1Beta1CronJobDeployer implements CronJobDeployer {
    ...
    public V1Beta1CronJobDeployer(@org.springframework.beans.factory.annotation.Value(
            "${datajobs.control.k8s.data.job.template.file}") String datajobTemplateFileLocation, @Qualifier("deploymentBatchV1beta1Api") BatchV1beta1Api deploymentBatchV1beta1Api,
