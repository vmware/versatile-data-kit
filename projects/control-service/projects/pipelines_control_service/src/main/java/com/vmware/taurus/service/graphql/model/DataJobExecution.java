...
public class DataJobExecution {
    ...
    @Schema(
            ...
            description = "URL link to persisted logs in central location. Logs generally should be available for longer time. The link is available only if operators have configured it during installation of Control Service. During install operators can configure logs to be persisted to log aggregator service whose link can be exposed here. ",
            requiredMode = RequiredMode.NOT_REQUIRED
    )
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return Objects.equals(this.id, dataJobExecution.id) && Objects.equals(this.jobName, dataJobExecution.jobName) && Objects.equals(this.status, dataJobExecution.status) && Objects.equals(this.type, dataJobExecution.type) && Objects.equals(this.startTime, dataJobExecution.startTime) && Objects.equals(this.endTime, dataJobExecution.endTime) && Objects.equals(this.startedBy, dataJobExecution.startedBy) && Objects.equals(this.logsUrl, dataJobExecution.logsUrl) && Objects.equals(this.message, dataJobExecution.message) && Objects.equals(this.opId, dataJobExecution.opId) && Objects.equals(this.deployment, dataJobExecution.deployment);
        } else {
            return false;
        }
    }
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.id, this.jobName, this.status, this.type, this.startTime, this.endTime, this.startedBy, this.logsUrl, this.message, this.opId, this.deployment});
    }
