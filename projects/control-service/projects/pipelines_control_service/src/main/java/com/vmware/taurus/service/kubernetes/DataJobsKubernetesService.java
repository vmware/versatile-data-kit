...
public class DataJobsKubernetesService extends KubernetesService {
    ...
    public DataJobsKubernetesService(
            ...
            CronJobDeployer cronJobDeployer, JobCommandProvider jobCommandProvider) {
        super(namespace, k8sSupportsV1CronJob, log, client, batchV1Api, batchV1beta1Api,
                cronJobDeployer, jobCommandProvider);
    }
}
