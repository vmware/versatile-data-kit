...
public enum JobFieldStrategyBy {
   ...
   DEPLOYMENT_FAILED_EXECUTIONS("deployments.executions.failedExecutions", "content/deployments/failedExecutions"),
   DEPLOYMENT_SUCCESSFUL_EXECUTIONS("deployments.executions.successfulExecutions", "content/deployments/successfulExecutions"),
