...
public enum JobFieldStrategyBy {
   ...
   DEPLOYMENT_LAST_EXECUTION_STATUS("deployments.lastExecution.status", "content/deployments/lastExecutionStatus"),
   DEPLOYMENT_LAST_EXECUTION_TIME("deployments.lastExecution.time", "content/deployments/lastExecutionTime"),
   DEPLOYMENT_LAST_EXECUTION_DURATION("deployments.lastExecution.duration", "content/deployments/lastExecutionDuration"),
