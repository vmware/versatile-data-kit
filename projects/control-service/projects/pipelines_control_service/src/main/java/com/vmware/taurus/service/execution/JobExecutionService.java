...
public class JobExecutionService {
  ...
  public JobExecutionService(JobsService jobsService, JobExecutionRepository jobExecutionRepository, DeploymentService deploymentService, DataJobsKubernetesService dataJobsKubernetesService, JobExecutionLogsUrlBuilder jobExecutionLogsUrlBuilder, OperationContext operationContext,
                             GitCredentialsProvider gitCredentialsProvider, GitWrapper gitWrapper,
    ...
    this.jobExecutionLogsUrlBuilder = jobExecutionLogsUrlBuilder;
  ...
  private String datajobsTempStorageFolder;
