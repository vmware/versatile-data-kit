...
public class JobExecutionService {
  ...
  public enum ExecutionType {
    MANUAL("manual"), // "manual" executions are ones ran through the `vdk execute --start` command and the startedBy value of the execution request must always be 'vdk-control-cli'
    SCHEDULED("scheduled");
  ...
  public String startDataJobExecution(
    ...
    try {
      ...
      // TODO: we need to extract "vdk-control-cli" as a global string as it currently appears here
      // and in the execution API
