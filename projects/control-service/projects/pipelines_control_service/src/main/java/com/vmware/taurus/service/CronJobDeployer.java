 ...
 * This interface abstracts out the differences and at runtime only a single cronjobdeployer will we
 * wired into the spring env depending on if cronjobv1 is supported or not
 */
