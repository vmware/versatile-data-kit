...
public abstract class KubernetesService {
    ...
    public void updateV1CronJob(
        ...
        var cronJob =
                v1CronJobFromTemplate(
                        ...
                        imagePullSecrets);
        V1CronJob nsJob =
                batchV1Api.replaceNamespacedCronJob(name, namespace, cronJob).execute();
    ...
    private List<V1Pod> listJobPods(V1Job job) throws ApiException {
        ...
        var pods =
                new CoreV1Api(client)
                        .listNamespacedPod(
                                namespace).labelSelector(labelSelector).execute()
                        .getItems();
    ...
    public Optional<String> getJobLogs(String jobName, Integer tailLines)
        ...
        if (job.isPresent()) {
            ...
            if (pods.size() > 0) {
                ...
                return Optional.of(readNamespacedPodLog(
    ...
    private String readNamespacedPodLog(
        ...
        return new CoreV1Api(client)
                .readNamespacedPodLog(
                        name, namespace).container(container).tailLines(tailLines).timestamps(true)
                .execute();
    }
        ...
        try (Watch<V1Job> watch =
                     Watch.createWatch(
                             ...
                             batchV1Api.listNamespacedJob(
                                     ...
                                     fieldSelector).timeoutSeconds(timeoutSeconds)
                                     .watch(true).buildCall(null),
        ...
        var status =
                new CoreV1Api(client)
                        .deleteCollectionNamespacedPod(
                                ...
                                namespace).labelSelector("job-name=" + name).execute();
    ...
    private Optional<V1Job> getJob(String jobName) throws ApiException {
        ...
        try {
            var jobs =
                    batchV1Api.listNamespacedJob(
                            namespace).fieldSelector(fieldSelector).execute();
    ...
    public void removeSecretData(String name) throws ApiException {
        ...
        try {
            var status =
                    new CoreV1Api(client)
                            .deleteNamespacedSecret(name, this.namespace).execute();
