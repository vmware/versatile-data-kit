...
public class UnsupportedPythonVersionException extends DomainError implements UserFacingError{
    public UnsupportedPythonVersionException(String pythonVersion, String supportedPythonVersions) {
        super(
                ...
                String.format("To deploy the data job, please set the python_version property to one of the supported versions: '%s'.", supportedPythonVersions),
                null);
    }
