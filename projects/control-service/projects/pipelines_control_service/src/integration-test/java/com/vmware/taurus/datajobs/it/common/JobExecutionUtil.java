...
import com.vmware.taurus.datajobs.it.DataJobTerminationStatusIT;
...
public class JobExecutionUtil {
  ...
  public static void checkDataJobExecutionStatus(
    ...
    try {
      testDataJobExecutionRead(executionId, executionStatus, opId, jobName, teamName, username, mockMvc);
      testDataJobExecutionList(executionId, executionStatus, opId, jobName, teamName, username, mockMvc);
  ...
  public static ImmutablePair<String, String> executeDataJob(String jobName, String teamName, String username, String deploymentId, MockMvc mockMvc) throws Exception {
            ...
            mockMvc
                    .perform(
                            post(triggerDataJobExecutionUrl)
                                    ...
                                    .content(objectMapper.writeValueAsString(new DataJobExecutionRequest().startedBy(username)))
  ...
  private static void testDataJobExecutionRead(
    ...
    com.vmware.taurus.controlplane.model.data.DataJobExecution[] dataJobExecution = new com.vmware.taurus.controlplane.model.data.DataJobExecution[1];
  ...
  private static void testDataJobExecutionLogs(
          String executionId, String jobName, String teamName, String username, MockMvc mockMvc) throws Exception {
    MvcResult dataJobExecutionLogsResult = getExecuteLogs(executionId, jobName, teamName, username, mockMvc);
  ...
  private static void assertDataJobExecutionValid(
    ...
    assertEquals(com.vmware.taurus.controlplane.model.data.DataJobExecution.TypeEnum.MANUAL, dataJobExecution.getType());
