...
public class KubernetesServiceTest {
    ...
    public void testCreateV1beta1CronJobFromInternalResource() {
        try {
            ...
            V1Beta1CronJobDeployer service = new V1Beta1CronJobDeployer(null, new BatchV1beta1Api(), "default");
            ...
            Method checkForMissingEntries =
                    V1Beta1CronJobDeployer.class.getDeclaredMethod(
            ...
            Method[] methods = V1Beta1CronJobDeployer.class.getDeclaredMethods();
    ...
    public void testCreateV1CronJobFromInternalResource() {
        try {
            ...
            Method loadInternalV1CronjobTemplate =
                    V1CronJobDeployer.class.getDeclaredMethod("loadInternalV1CronjobTemplate");
            ...
            V1CronJobDeployer service = new V1CronJobDeployer(null, new BatchV1Api(), "default");
            ...
            Method checkForMissingEntries =
                    V1CronJobDeployer.class.getDeclaredMethod("v1checkForMissingEntries", V1CronJob.class);
            if (checkForMissingEntries == null) {
            ...
            Assertions.assertNotNull(internalCronjobTemplate.getSpec().getJobTemplate().getMetadata());
            // Step 3 - create and check the actual cronjob.
            Method[] methods = V1CronJobDeployer.class.getDeclaredMethods();
            // This is much easier than describing the whole method signature.
            Optional<Method> method =
                    Arrays.stream(methods)
    ...
    public void testV1beta1CronJobFromTemplate_emptyImagePullSecretsList() {
        V1beta1CronJob v1beta1CronJob =
                new V1Beta1CronJobDeployer(null, new BatchV1beta1Api(), "default").v1beta1CronJobFromTemplate(
                        "",
                        "",
                        true,
                        null,
    ...
    public void testV1CronJobFromTemplate_emptyImagePullSecretsList() {
        V1CronJob v1CronJob =
                new V1CronJobDeployer(null, new BatchV1Api(), "default").v1CronJobFromTemplate(
                        "",
                        "",
                        true,
                        null,
