...
def vdk_configure(config_builder: ConfigurationBuilder) -> None:
    ...
    config_builder.add(
        ...
        default_value="",
        description="SThe path in the http URL. Used only when `use_http_transport` is True.",
    )
    config_builder.add(
        ...
        description=(
            ...
            "Used only when `use_http_transport` is True. By default 'auth_cookie_names' is set to the "
            "list of auth cookie names used by Impala and Hive. If 'auth_cookie_names' is explicitly set to "
