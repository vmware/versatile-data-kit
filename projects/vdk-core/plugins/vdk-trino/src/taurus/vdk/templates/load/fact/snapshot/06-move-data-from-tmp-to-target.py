...
def run(job_input: IJobInput):
    ...
    if res and res[0][0] == 0:
        ...
        return
    log.debug("Confirmed that tmp target has data, proceed with moving it to target.")
    ...
    try:
        ...
        if _try_recover_target_from_backup(
            ...
            errors.log_and_throw(
                ...
                why_it_happened=f"""Step with moving data from tmp table to target table failed, so recovery from "
